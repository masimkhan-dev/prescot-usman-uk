...
const DIRECTIONS: Array<{ id: Direction; number: string; name: string; note: string }> = [
  { id: "motion", number: "01", name: "Precision Motion", note: "Bright · exact · energetic" },
  {
    ...
    note: "Warm · expressive · retail-led",
  },
  {
    id: "immersive",
    number: "03",
    name: "Immersive Digital",
    note: "Cinematic · confident · progressive",
  },
];
...
const PRODUCTS = [
  {
    label: "Phones",
    image: "/design-lab/product-phone.jpg",
    copy: "New, used and refurbished devices",
  },
  {
    label: "Laptops",
    image: "/design-lab/product-laptop.jpg",
    copy: "Laptops for home, study and work",
  },
  {
    label: "Gaming",
    image: "/design-lab/product-console.jpg",
    copy: "Consoles, controllers and essentials",
  },
  {
    label: "Accessories",
    image: "/design-lab/product-accessories.jpg",
    copy: "Everyday charging and protection",
  },
];
...
const METHODS = [
  { icon: MapPin, index: "01", name: "Walk in", copy: "Visit us at 57 Eccleston Street, Prescot." },
  {
    ...
    index: "02",
    name: "Door to door",
    copy: "Ask about collection and return options.",
  },
  {
    icon: PackageCheck,
    index: "03",
    name: "Mail in",
    copy: "Contact the team before posting your device.",
  },
];
...
const QUOTE_STEPS = [
  {
    ...
    options: ["Mobile phone", "Laptop or computer", "Tablet", "Gaming console"],
  },
  {
    label: "Issue",
  ...
  {
    label: "Method",
    title: "How would you like service?",
    options: ["Walk in", "Door to door", "Mail in", "Help me choose"],
  },
];
...
function DesignLab() {
  ...
  const selectQuoteOption = (value: string) => {
    ...
    window.setTimeout(
      () => setQuoteStep((step) => Math.min(step + 1, QUOTE_STEPS.length - 1)),
      160,
    );
  };
  ...
  const previousProduct = () =>
    setProduct((value) => (value - 1 + PRODUCTS.length) % PRODUCTS.length);

  return (
    <div className={`design-lab dl-${direction}`}>
      <a className="dl-skip" href="#dl-main">
      ...
      <div className="dl-site-shell">
        ...
        <header className="dl-header">
          <a
            href="#dl-main"
            className="dl-brand"
            aria-label="Prescot Mobiles & Computer Services home"
          >
            <span className="dl-logo-wrap">
              <img src="/design-lab/prescot-logo.png" alt="Prescot Mobile Shop logo" />
            </span>
            <span className="dl-brand-name">
              <b>Prescot</b>
              <small>Mobiles & Computer Services</small>
            </span>
          </a>
          ...
          <div className="dl-header-actions">
            <a className="dl-text-action" href={BUSINESS.phoneHref}>
              <Phone aria-hidden="true" /> Call now
            </a>
            <a className="dl-button dl-button-primary" href="#quote">
          ...
          >
            ...
            <span className="dl-sr-only">Open menu</span>
          </button>
        </header>

        <div
          className={`dl-mobile-menu ${menuOpen ? "is-open" : ""}`}
          id="dl-mobile-menu"
          ...
          <div className="dl-mobile-panel">
            <div className="dl-mobile-panel-head">
              ...
              <button type="button" onClick={() => setMenuOpen(false)}>
                <X aria-hidden="true" />
                <span className="dl-sr-only">Close menu</span>
              </button>
            </div>
            <nav aria-label="Mobile navigation">
              ...
              <a href="#methods" onClick={() => setMenuOpen(false)}>
                Ways to repair <ArrowRight />
              </a>
            ...
            <a
              className="dl-button dl-button-primary"
              href="#quote"
              onClick={() => setMenuOpen(false)}
            >
              Get a quote
            </a>
            <a className="dl-button dl-button-secondary" href={BUSINESS.phoneHref}>
              Call {BUSINESS.phone}
            </a>
          </div>
        </div>
        ...
        <main id="dl-main">
          <section className="dl-hero dl-reveal">
            <div className="dl-hero-copy">
              <p className="dl-kicker">
                <span /> Device support for real life
              </p>
              <h1>
                Repair, replace or upgrade. <em>Start here.</em>
              </h1>
              <p className="dl-lede">
                Clear advice for phones, laptops, computers, tablets and gaming consoles—available
                in store, door to door, or by mail.
              </p>
              <div className="dl-hero-actions">
                <a href="#quote" className="dl-button dl-button-primary">
                  Get a quote <ArrowRight />
                </a>
                <a href={BUSINESS.phoneHref} className="dl-button dl-button-secondary">
                  <Phone /> Call now
                </a>
              </div>
              <a
                className="dl-whatsapp-link"
                href={BUSINESS.whatsappMessage("Hi Prescot Mobiles, I'd like help with a device.")}
                target="_blank"
                rel="noreferrer"
              >
              ...
              <div className="dl-hero-proof">
                <span>
                  <MapPin /> Prescot, L34 5QH
                </span>
                <span>
                  <Wrench /> Repairs & device retail
                </span>
                <span>
                  <Clock3 /> Open 7 days
                </span>
            ...
            <div className="dl-hero-media">
              <figure>
                <img
                  src="/design-lab/hero-workbench.jpg"
                  alt="Phones, laptop, game controller and repair tools arranged on a workbench"
                />
              </figure>
              <div className="dl-media-note">
                <span>
                  <b>Not sure what failed?</b>
                  <small>Tell us what happened and we’ll guide the next step.</small>
                </span>
                <a href="#quote" aria-label="Start a repair quote">
                  <ArrowRight />
                </a>
              </div>
            </div>
          ...
          <section className="dl-retail dl-section dl-reveal" id="retail">
            <div className="dl-retail-copy">
              ...
              <p>
                Explore phones, laptops, gaming and accessories. Contact the team to check current
                availability.
              </p>
              <div className="dl-product-tabs" role="tablist" aria-label="Product categories">
                {PRODUCTS.map((item, index) => (
                  <button
                    type="button"
                    role="tab"
                    aria-selected={product === index}
                    className={product === index ? "is-active" : ""}
              ...
              <a className="dl-inline-arrow" href="/products">
            ...
            <div className="dl-product-stage">
              <div className="dl-product-image" key={PRODUCTS[product].label}>
                <img
                  ...
                  alt={`${PRODUCTS[product].label} product category`}
                />
              </div>
              <div className="dl-product-caption">
                <span>
                  <b>{PRODUCTS[product].label}</b>
                  <small>{PRODUCTS[product].copy}</small>
                </span>
                <div>
                  <button
                    type="button"
                  ...
                  <button type="button" onClick={nextProduct} aria-label="Next product category">
                    <ChevronRight />
                  </button>
                </div>
              </div>
          ...
          <section className="dl-quote dl-section dl-reveal" id="quote">
            <div className="dl-quote-intro">
              ...
              <p>
                Choose a few details. The final enquiry can continue with the existing contact and
                WhatsApp journey.
              </p>
              <div
                className="dl-quote-progress"
                aria-label={`Step ${quoteStep + 1} of ${QUOTE_STEPS.length}`}
              >
                {QUOTE_STEPS.map((step, index) => (
                  <button
                    type="button"
                    className={
                      index === quoteStep ? "is-active" : index < quoteStep ? "is-complete" : ""
                    }
                    onClick={() => setQuoteStep(index)}
                    key={step.label}
                  >
                    <span>{index < quoteStep ? <Check /> : index + 1}</span>
                    {step.label}
                  </button>
                ))}
              </div>
            ...
            <div className="dl-quote-card" key={quoteStep}>
              <span className="dl-step-count">
                0{quoteStep + 1} / 0{QUOTE_STEPS.length}
              </span>
              ...
              <div className="dl-quote-options">
                {QUOTE_STEPS[quoteStep].options.map((option) => (
                  <button
                    type="button"
                    className={selections[quoteStep] === option ? "is-selected" : ""}
            ...
            <div className="dl-method-list">
              {METHODS.map((method) => (
                <article key={method.name}>
                  ...
                  <h3>{method.name}</h3>
                  <p>{method.copy}</p>
                  <a href="#quote" aria-label={`Ask about ${method.name}`}>
                    <ArrowRight />
                  </a>
                </article>
              ))}
          ...
          <section className="dl-trust dl-section dl-reveal">
            <div className="dl-trust-quote">
              ...
              <blockquote>
                “Speak to a real person, explain the problem clearly, and choose the next step with
                confidence.”
              </blockquote>
            ...
            <div className="dl-trust-points">
              ...
              <div>
                ...
                <span>
                  ...
                  <small>Understand the proposed work before deciding.</small>
                </span>
              </div>
              <div>
                <ShoppingBag />
                <span>
                  <b>Repair and retail together</b>
                  <small>Explore repair, replacement and upgrade routes.</small>
                </span>
              </div>
              <div>
                <Star />
                <span>
                  <b>Verified proof belongs here</b>
                  <small>Connect a real review source before publishing claims.</small>
                </span>
              </div>
            </div>
          </section>
          ...
          <section className="dl-visit dl-section dl-reveal" id="visit">
            <div className="dl-visit-map" aria-hidden="true">
              ...
              <span className="dl-map-pin">
                <MapPin />
              </span>
              <span className="dl-map-label">
                Prescot
                <br />
                <small>L34 5QH</small>
              </span>
          ...
          <section className="dl-final-cta dl-reveal">
            <div>
              ...
              <h2>Let’s find the right next step for your device.</h2>
            </div>
            <div>
              <a className="dl-button dl-button-primary" href="#quote">
                Get a quote <ArrowRight />
        ...
        <footer className="dl-footer">
          <div className="dl-footer-brand">
            <span className="dl-logo-wrap">
              <img src="/design-lab/prescot-logo.png" alt="" />
            </span>
            <div>
              <b>Prescot Mobiles & Computer Services</b>
              <p>
                Mobile, laptop, computer, tablet and gaming-console repairs, plus device retail and
                accessories.
              </p>
            </div>
          </div>
          <div>
            <b>Repairs</b>
            <a href="#services">Mobile phones</a>
            <a href="#services">Computers & laptops</a>
            <a href="#services">Tablets</a>
            <a href="#services">Gaming consoles</a>
          </div>
          <div>
            <b>Contact</b>
            <a href={BUSINESS.phoneHref}>{BUSINESS.phone}</a>
            <a href={BUSINESS.emailHref}>{BUSINESS.email}</a>
            <a href={BUSINESS.mapsDirections}>Find the shop</a>
          </div>
          <div>
            <b>Service options</b>
            <a href="#methods">Walk in</a>
            <a href="#methods">Door to door</a>
            <a href="#methods">Mail in</a>
          </div>
          <p className="dl-footer-base">
            Concept preview · Real business details · Claims require approval before publication
          </p>
        </footer>
