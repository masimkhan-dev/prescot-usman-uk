      ...
      <div className="bg-[#FAFAF9] border-b border-slate-200 py-12">
        <div className="container-page max-w-4xl">
          ...
          <p className="mt-2 text-slate-600 text-sm">
            Last Updated: January 2026 • Compliant with UK General Data Protection Regulation (UK
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed text-sm md:text-base">
          <section className="card-flat">
            ...
            <p className="mt-2 text-xs text-slate-500">
              Contact:{" "}
              <a href={BUSINESS.emailHref} className="text-[#D92D20] underline">
                {BUSINESS.email}
              </a>{" "}
          ...
          <section className="card-flat">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-slate-600">
              ...
              <li>
                <strong>Repair & Device Records:</strong> Device model, serial number/IMEI, fault
                description, passcode (where explicitly authorized for diagnostic testing), and
                repair history.
              </li>
              <li>
                <strong>Transaction Data:</strong> Details of quotes, payments, invoices, and
                trade-in valuations.
              </li>
              <li>
                <strong>Technical Data:</strong> IP address, browser type, and essential website
                cookies required for navigation.
              </li>
            </ul>
          </section>
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <div className="text-xs text-slate-600 mt-1">
                  To process repair bookings, issue quotes, process payments, and fulfill warranty
                  claims.
                </div>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
