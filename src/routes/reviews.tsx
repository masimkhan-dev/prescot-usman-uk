...
const reviews = [
  {
    name: "Sarah W.",
    text: "Fixed my iPhone screen in under an hour. Friendly staff and fair price. Highly recommend to anyone in Prescot.",
    rating: 5,
    service: "iPhone screen replacement",
  },
  {
    name: "James P.",
    text: "Sorted my PS5 HDMI port when others said it wasn't worth repairing. Absolute lifesavers.",
    rating: 5,
    service: "PS5 repair",
  },
  {
    name: "Aisha K.",
    text: "Bought a refurbished Galaxy from them — looks and works like new. Great local shop.",
    rating: 5,
    service: "Refurbished phone",
  },
  {
    name: "Mark T.",
    text: "My laptop was running so slow. They upgraded the SSD and it's like a brand new machine. Cheers!",
    rating: 5,
    service: "Laptop upgrade",
  },
  {
    name: "Emma R.",
    text: "Mail-in repair worked perfectly. Sent my Pixel off Monday, back by Friday all fixed.",
    rating: 5,
    service: "Mail-in repair",
  },
  {
    name: "David H.",
    text: "Honest advice — they told me a repair wasn't worth it and helped me pick a used replacement instead. Rare these days.",
    rating: 5,
      ...
      <section className="section-pad">
        ...
        <div className="container-page mt-16 text-center">
          <p className="text-muted-foreground">
            Had a great experience? We'd love your review on Google.
          </p>
